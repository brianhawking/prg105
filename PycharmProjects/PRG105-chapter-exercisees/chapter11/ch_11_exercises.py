...
class Dwelling:
    ...
    # 2) Add mutators for all the data attributes (number_of_rooms, square_feet, floors)
    ...
    # 3) Add accessors for all the data attributes
...
def main():
    ...
    single_family_home = SingleFamilyHome(6, 1200, 1, "single car garage", 0.25)
    # 8) Display the data using the accessor methods

    print(f"Number of rooms: {single_family_home.get_number_of_rooms()} rooms")
    print(f"Square footage: {single_family_home.get_square_feet()} square feet")
    print(f"Number of floors: {single_family_home.get_floors()} floor(s)")
    print(f"Garage type: {single_family_home.get_garage_type()}")
    print(f"Yard Size: {single_family_home.get_yard_size()} acres")
...
def main2():
    ...
    print("Here are some mammals and some sounds they make")
    print("-----------------------------------------------")
