...
dogs_cursor.execute("""INSERT INTO Dogs (DogName, OwnerName, Breed)
                    VALUES ("Piper", "Brian", "Black Lab Mix")
                    """)

dogs_cursor.execute("""INSERT INTO Dogs (DogName, OwnerName, Breed)
                    VALUES ("Jamie", "Casey", "Black Lab Mix")
                    """)

dogs_cursor.execute("""INSERT INTO Dogs (DogName, OwnerName, Breed)
                    VALUES ("Jax", "Adam", "Rat Terrier")""")
...
for row in results:
    print(f"{row[0]:30} {row[1]:5} {row[2]:6} {row[3]:10}")
...
print(f"{result[0]:30} {result[1]:5} {result[2]:6} {row[3]:10}")
